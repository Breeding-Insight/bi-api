...
CREATE TABLE trait_observation_level (
    like base_entity INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING INDEXES,
    trait_id UUID,
...
ALTER TABLE trait_observation_level ADD FOREIGN KEY (trait_id) REFERENCES trait (id);
ALTER TABLE trait_observation_level ADD FOREIGN KEY (program_observation_level_id) REFERENCES program_observation_level (id);
ALTER TABLE trait_observation_level ADD FOREIGN KEY (created_by) REFERENCES bi_user (id);
ALTER TABLE trait_observation_level ADD FOREIGN KEY (updated_by) REFERENCES bi_user (id);