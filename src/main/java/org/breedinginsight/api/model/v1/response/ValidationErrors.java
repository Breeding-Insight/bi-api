...
public class ValidationErrors {
    ...
    public void addError(Integer rowNumber, ValidationError validationError){
        ...
        RowValidationErrors newRow = new RowValidationErrors(rowNumber);
    ...
    public void mergeAll(ValidationErrors ...validationErrors){
        for (ValidationErrors validationErrors1: validationErrors){
            this.merge(validationErrors1);
        }
    }
