...
import static org.breedinginsight.dao.db.Tables.IMPORTER_MAPPING;
import static org.breedinginsight.dao.db.Tables.IMPORTER_MAPPING_PROGRAM;

@Singleton
public class ImportMappingDAOImpl extends ImporterMappingDao implements ImportMappingDAO {

    private DSLContext dsl;
    private ObjectMapper objectMapper;

    @Inject
    public ImportMappingDAOImpl(Configuration config, DSLContext dsl, ObjectMapper objectMapper) {
        super(config);
        this.dsl = dsl;
